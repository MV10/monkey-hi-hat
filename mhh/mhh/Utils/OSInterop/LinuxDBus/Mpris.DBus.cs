...
// This is a machine-generated file wrapping all MPRIS.DBus properties and functions.
...
class MprisPlayer : MprisObject
{
    private const string __Interface = "org.mpris.MediaPlayer2.Player";
    public MprisPlayer(MprisService service, ObjectPath path) : base(service, path)
    { }
