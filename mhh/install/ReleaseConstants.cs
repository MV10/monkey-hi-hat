...
namespace mhhinstall
{
    public class ReleaseConstants
    {
        ...
        public static readonly Version appVersion = new Version("5.5.0");
        //                                                       ^ update version

        public static readonly string programUrl = "https://www.monkeyhihat.com/installer_assets/mhh-win-5-5-0.zip";
        //                                                                                               ^ update version

        public static readonly string contentUrl = "https://www.monkeyhihat.com/installer_assets/mhh-content-5-5-0.zip";
        //                                                                                                   ^ update version

        public static readonly string textureUrl = "https://www.monkeyhihat.com/installer_assets/mhh-texture-5-5-0.zip";
        //                                                                                                   ^ update version
        ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
