...
This should run on almost any Windows or Linux PC with a decent NVIDIA or AMD graphics card and practically any type of audio playback. (Only Windows 11 is supported. For Linux I can only test against Debian 13 and KDE using X11.)
